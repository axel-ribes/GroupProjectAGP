...
void draw(SDL_Window * window)
{
	...
	mvStack.push(mvStack.top());
	mvStack.top() = glm::translate(mvStack.top(), glm::vec3(-7.0f, 1.0f, -3.0f));
	mvStack.top() = glm::scale(mvStack.top(), glm::vec3(1.0, 1.0, 1.0));
	rt3d::setUniformMatrix4fv(phongShader, "modelview", glm::value_ptr(mvStack.top()));
	rt3d::setMaterial(phongShader, material1);
	rt3d::drawIndexedMesh(meshObjects[0], meshIndexCount, GL_TRIANGLES);
	mvStack.pop();
	...
	glBindTexture(GL_TEXTURE_2D, textures[1]);
	mvStack.push(mvStack.top());
	mvStack.top() = glm::translate(mvStack.top(), glm::vec3(0.0, 1.0f, -10.0f));
	mvStack.top() = glm::scale(mvStack.top(), glm::vec3(4.0, 5.0, 1.0));
	rt3d::setUniformMatrix4fv(phongShader, "modelview", glm::value_ptr(mvStack.top()));
	rt3d::setMaterial(phongShader, material1);
	rt3d::drawIndexedMesh(meshObjects[0], meshIndexCount, GL_TRIANGLES);
	mvStack.pop();
