...
// Display (hopefully) useful error messages if shader fails to compile or link
    ...
    GLuint createMesh(const GLuint numVerts, const GLfloat *vertices, const GLfloat *colours,
                      const GLfloat *normals, const GLfloat *texcoords, const GLuint indexCount,
        ...
        auto *pMeshBuffers = new GLuint[5];
        ...
        glVertexAttribPointer((GLuint) RT3D_VERTEX, 3, GL_FLOAT, GL_FALSE, 0, nullptr);
        ...
        if (colours != nullptr) {
            ...
            glVertexAttribPointer((GLuint) RT3D_COLOUR, 3, GL_FLOAT, GL_FALSE, 0, nullptr);
        ...
        if (normals != nullptr) {
            ...
            glVertexAttribPointer((GLuint) RT3D_NORMAL, 3, GL_FLOAT, GL_FALSE, 0, nullptr);
        ...
        if (texcoords != nullptr) {
            ...
            glVertexAttribPointer((GLuint) RT3D_TEXCOORD, 2, GL_FLOAT, GL_FALSE, 0, nullptr);
    ...
    void updateMesh(const GLuint mesh, const unsigned int bufferType, const GLfloat *data, const GLuint size) {
        ...
        glVertexAttribPointer((GLuint) bufferType, 3, GL_FLOAT, GL_FALSE, 0, nullptr);
